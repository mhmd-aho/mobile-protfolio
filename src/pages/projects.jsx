                        ...
                        return(
                            <div onClick={()=>setShowModal(index)} key={index} className="relative flex flex-col justify-start items-start h-96 w-full border border-black/20 bg-black/10 rounded-lg shadow-lg">
                                ...
                                <div className="flex flex-col gap-1 justify-start items-start h-1/2 w-full p-2">
                                    ...
                                    <p className="text-sm text-black/50">{project.des}</p>
                                </div>
                                {
                                    showModal === index && (
                                        <div onClick={(e)=>{
                                            ...
                                            <div className="flex gap-2 justify-start items-start h-fit w-fit p-2">
                                                <a onClick={(e)=>e.stopPropagation()} className="px-4 py-2 border rounded-lg border-blue-600 bg-blue-500 shadow-lg text-white" href={project.link} target="_blank" rel="noopener noreferrer">Visit</a>
                                                <a onClick={(e)=>e.stopPropagation()} className="px-4 py-2 border rounded-lg border-black/20 bg-black/10 shadow-lg text-black/50" href={project.repo} target="_blank" rel="noopener noreferrer">Repo</a>
                                            </div>
                                        </div>
                                    )
                                }
